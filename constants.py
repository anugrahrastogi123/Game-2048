SIZE = 400 #size of the screen will be 400x400
GRID_LEN = 4
GRID_PADDING = 5

BACKGROUND_COLOUR_GAME = "#92877d"
BACKGROUND_COLOUR_CELL_EMPTY = "#9e948a"

BACKGROUND_COLOUR_DICT = {2: "#eee4da", 4: "#ede0c8", 8: "#f2b179",
